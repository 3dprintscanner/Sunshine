...
public class WeatherDataParser {
    ...
    public String[] formattedData(String jsondata) throws JSONException{

        return getWeatherDataFromJson(jsondata,7);
    }
    ...
    public static double getMaxTemperatureForDay(String weatherJsonString, int dayIndex) throws JSONException{
        ...
        JSONObject listObject = jsonArray.getJSONObject(dayIndex);
        JSONObject tempObject = listObject.getJSONObject("temp");
        double maxTempDouble = tempObject.getDouble("max");
        return maxTempDouble;
    }
